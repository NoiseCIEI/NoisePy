...
NNStream=obspy.Stream();
# fkdatadir='./ak135_Q_15';
NNdatadir='/projects/life9360/code/CPSPy/sac_dir'
for sacfname in glob.glob(NNdatadir+"/*ZVF.sac"):
    Tr=obspy.read(sacfname)[0];
    Tr.stats.distance=Tr.stats.sac.dist;
    # Tr.stats.sac.b=3.52536799194+Tr.stats.sac.b
    # Tr.stats.sac.b=Tr.stats.sac.b-0.834714504583
    Tr.stats.sac.b=Tr.stats.sac.b-0.766742532418
    NNStream.append(Tr)
...
for trace in NNStream:
    ...
    nTr.aftan(tmin=5, tmax=70,ffact=100.);
...
# CampArr=AmpArr*np.sin(DeltaArr*np.pi/180.)  /np.sin(DeltaArr[minindex]*np.pi/180.) 
...
NNStream.plot(type='section',  alpha=1)#     
