...
#f2py -h pyaftan.pyf -m pyaftan aftanipg.f aftanpg.f fmax.f  ftfilt.f  mspline.f  phtovel.f  pred_cur.f  taper.f tapers.f  tgauss.f  trigger.f 
f2py -c pyaftan.pyf aftanipg.f aftanpg.f fmax.f  ftfilt.f  mspline.f  phtovel.f  pred_cur.f  taper.f tapers.f  tgauss.f  trigger.f -lfftw3 --f77flags=-ffixed-line-length-none --fcompiler=gfortran
